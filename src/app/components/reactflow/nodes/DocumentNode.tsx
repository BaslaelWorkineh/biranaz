...
const DocumentNode = (node: NodeProps) => {
  const { data } = node;
  ...
  return (
    <>
      <Card
        ...
        className={` flex flex-col gap-6 justify-center items-center min-w-fit min-h-fit max-h-[40rem] ${
          data.label > 5 ? "bg-[#e0c17f]" : "bg-[rgb(242,243,216)]"
        }  text-gray-900 font-bold text-sm p-24 rounded-[15px] shadow-lg shadow-[rgba(30,30,30,1)] border-2 border-brown-600`}
      >
        ...
        <CardBody color="rgba(30,30,30,1)">
          <div className="mb-3 flex items-center justify-between">
            ...
            <Typography variant="h5" color="blue-gray" className="font-medium bg-brown-600">
              {data.value}
            </Typography>
        ...
        <Handle
          ...
          className="hover:bg-brown-600 transition-all duration-500"
          type="target"
